...
(function(window,jQuery,undefined,System){
	...
	Tools.prototype = {
		...
		'set_whole_screen_size':function(obj){
			...
			var width,height,getWindowSize=System.Basis.getBodySize;
        ...
        'hover_image':function($focus_image,init){
            ...
            .click(function(event){
                event=System.Basis.fixEvt(event);
                //选择当前的把之前的恢复默认的图片 
		...
		*/
		...
		'enterToTab':function(inputs,event, input) {  
		    var e = System.Basis.fixEvt(event);
		    if(e.keyCode == 13) {  
	...
	System.extends(Tools,System.Helper,1);
	System['Tools']=Tools;
